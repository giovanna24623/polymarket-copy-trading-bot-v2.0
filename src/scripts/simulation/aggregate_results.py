...
from src.utils.paths import STRATEGY_RESULTS_DIR, SIMULATION_RESULTS_DIR, ensure_directories
...
def load_result_files(dirs: List[str | Path]) -> tuple[Dict[str, StrategyPerformance], Dict[str, Dict], int]:
...
def save_aggregated_results(strategies: List[StrategyPerformance], traders: List[tuple], total_files: int):
    ...
    from src.utils.paths import STRATEGY_RESULTS_DIR, SIMULATION_RESULTS_DIR, ensure_directories
    ensure_directories()
    output_dir = STRATEGY_RESULTS_DIR
...
def aggregate_results():
    ...
    # Result directories to scan (using new centralized paths)
    dirs = [
        'trader_scan_results',
        'trader_analysis_results',
        'top_traders_results',
        STRATEGY_RESULTS_DIR,  # Strategy factory results (new location)
        SIMULATION_RESULTS_DIR,  # Simulation results (new location)
