...
from src.utils.paths import TRADER_DATA_CACHE_DIR, ensure_directories
...
def save_trades_to_cache(address: str, trades: List[Dict[str, Any]]):
    ...
    cache_dir = TRADER_DATA_CACHE_DIR
...
async def fetch_historical_trades():
    ...
    print(f"{Fore.CYAN}Cache directory: {TRADER_DATA_CACHE_DIR}{Style.RESET_ALL}")
    print()
